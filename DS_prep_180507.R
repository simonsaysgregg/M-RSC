...
## Reformat dates
rain$timestamp <- mdy_hms(rain$timestamp, tz = "GMT")
##View(rain)
## Join rainfall data
...
## Reformat dates
in1.ft$timestamp <- mdy_hms(in1.ft$timestamp, tz = "GMT")
##View(in1.ft)
## Join in1.ft data
...
## Reformat dates
out.ft$timestamp <- mdy_hms(out.ft$timestamp, tz = "GMT")
##View(out.ft)
## Join out.ft data
...
## Reformat dates
out.velo$timestamp <- mdy_hms(out.velo$timestamp, tz = "GMT")
##View(out.velo)
## Join out.velo data
